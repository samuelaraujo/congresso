                ...
                <div class="white-box">
                    ...
                    <ul class="nav nav customtab nav-tabs hidden" role="tablist">
                        <li class="nav-item">
                            <a href="#status" id="primeiro" data-status="1"
                                ...
                                <span class="hidden-xs"> Credenciamento - 1° dia</span>
                    ...
                    <div id="add" class="pull-right hidden">
                        <button class="btn btn-info btn-sm btn-add waves-effect waves-light" type="button">
                            <span class="btn-label"><i class="fa fa-plus"></i></span>Entrada ou Saída
                        </button>
                    </div>
...
<script type="text/javascript" src="javascripts/administrador/presenca/list.js"></script>
