        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/administrador/pagamento">Clientes</a></li>
                                ...
                                <form>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            class="form-control input-sm" placeholder="Busca por código, nome ou CPF">
...
<script type="text/javascript" src="javascripts/administrador/cliente/list.js"></script>
