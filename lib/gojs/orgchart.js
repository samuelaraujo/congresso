 function init(json) {
    ...
    function findHeadShot(key) {
      if (key > 500) return ""; // There are only 16 images on the server
      //return "images/HS" + key + ".png"
      return "lib/gojs/images/HSnopic.png"
    };
      ...
      $(go.Node, "Auto",
        ...
        $(go.Panel, "Horizontal",
          ...
          $(go.Panel, "Table",
            ...
            $(go.TextBlock, textStyle(),
              { row: 2, column: 3, },
              new go.Binding("text", "parent", function(v) {return "Pai: " + v;})),
  ...
  function load(json) {
    //var json = '{"class":"go.TreeModel", "nodeDataArray":[ '+document.getElementById("mySavedModel").value+' ] }';
    //console.log(json);
