...
$(document).ready(function(){
    ...
    function list(reload = false, search = undefined, status = 4){
        ...
        app.util.getjson({
            ...
            success: function(response){
                ...
                for (var i=0;i<response.results.length;i++) {
                    var material, entrada, saida = undefined;
                    ...
                    if(response.results[i].entrada == undefined ){
                        entrada = 'N/A';
                    }else{
                        entrada = response.results[i].entrada;
                    }

                    if(response.results[i].saida == undefined ){
                        saida = 'N/A';
                    }else{
                        saida = response.results[i].saida;
                    }
